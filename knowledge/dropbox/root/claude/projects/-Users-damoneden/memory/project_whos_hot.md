...
type: project
tags: [music-industry, crm, tiktok, influencers, claude-api, apify, single-file-app, html, javascript]
related:
...
- **[TradeKraft](project_tradekraft.md)** — Who's Hot is the manual/standalone version of TradeKraft's Influencer Engine (Agent 7). Who's Hot discovers and ranks TikTok creators by hashtag/niche; TradeKraft automates the outreach at scale. These tools are designed to complement each other — Who's Hot could feed creator lists directly into TradeKraft's outreach pipeline.
